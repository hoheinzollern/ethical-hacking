...
which also a run through of the thought process in their solve.py.
...
Getting a proper grasp of angr, takes time, so feel free to check some of the other examples out in the future :-)
